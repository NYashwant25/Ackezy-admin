...
export class ProfileComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.confirmPasswordForm = this.formBuilder.group({
            currentPassword: [this.user.firstName, [Validators.required,
            ...
            confirmPassword: [this.user.mobileNo, [Validators.required,
                Validators.minLength(this.validator.password.min),
                Validators.maxLength(this.validator.password.max)
            ]]
        }, {
    ...
    onProfileSubmit() {
        ...
        this.authenticationService.profileUpdate(formData).pipe(first())
            .subscribe(
                data => {
    ...
    onPasswordSubmit() {
        ...
        this.authenticationService.changePassword(userData)
            .pipe(first())
            .subscribe(
                data => {
                    if (data.code === 200) {
